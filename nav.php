...
<html lang="en">
    <head>
        ...
        <title>Pemilihan Cabang OlahRaga DISPORA Kota Medan</title>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
                <div class="navbar-header">
                    <a class="navbar-brand" href="" style="color: blue;" >SIPBOGA</a>
                </div>
...
if (isset($_GET['page'])) {
      ...
      if ($_GET['page'] == "editsiswa") {
           include 'aksi/editsiswa.php';
       }
