...
<body style="background-image:url(css/bg.jpeg);background-size:cover">
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h1 class="panel-title text-center">SPK PEMILIHAN CABANG OLAHRAGA</h1>
                        <center><img class="img-fluid" src="css/II.png" width="50%"><br></center>
                    </div>
